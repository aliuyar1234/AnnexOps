...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('evidence_refs', postgresql.ARRAY(postgresql.UUID(as_uuid=True)), nullable=False, server_default='{}'),
    ...
    op.create_table(
        ...
        sa.Column('compare_version_id', postgresql.UUID(as_uuid=True), sa.ForeignKey('system_versions.id', ondelete='SET NULL'), nullable=True),
