...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('hr_use_case_type', postgresql.ENUM('recruitment_screening', 'application_filtering', 'candidate_matching', 'performance_evaluation', 'employee_monitoring', 'task_allocation', 'promotion_termination', 'other_hr', name='hr_use_case_type', create_type=False), nullable=False),
        sa.Column('intended_purpose', sa.Text, nullable=False),
        sa.Column('deployment_type', postgresql.ENUM('saas', 'onprem', 'hybrid', name='deployment_type', create_type=False), nullable=False),
        sa.Column('decision_influence', postgresql.ENUM('assistive', 'semi_automated', 'automated', name='decision_influence', create_type=False), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column('result_label', postgresql.ENUM('likely_high_risk', 'unclear', 'likely_not', name='assessment_result', create_type=False), nullable=False),
